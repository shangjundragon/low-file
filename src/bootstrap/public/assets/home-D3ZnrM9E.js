import{d as pe,h as d,r as P,u as xt,a as ht,c as mt,m as yt,b as St,F as Le,N as Ct,e as wt,i as zt,f as ee,o as Pt,g as r,j as l,k as m,l as z,n as Rt,p as ne,q as ye,V as ie,s as Tt,t as _e,w as U,v as $e,x as Lt,y as V,z as _t,A as j,B as q,C as $t,D as Bt,E as Wt,T as At,G as kt,H as le,I as Vt,J,K as Se,L as jt,M as se,O as N,P as de,Q as Mt,R as Q,S as Z,U as Et,W as Ht,X as Ce}from"./index-DlMFiZZp.js";import{u as Gt}from"./use-message-BH62ekex.js";import{A as Ft,t as be}from"./Add-CB85-EOn.js";import{c as we,a as It,u as ze,o as Ot,_ as Dt}from"./Select-BbQ_ELN6.js";import{u as Nt}from"./Suffix-CHjmfDma.js";const Ut=we(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[we("&::-webkit-scrollbar",{width:0,height:0})]),Xt=pe({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=P(null);function n(i){!(i.currentTarget.offsetWidth<i.currentTarget.scrollWidth)||i.deltaY===0||(i.currentTarget.scrollLeft+=i.deltaY+i.deltaX,i.preventDefault())}const b=xt();return Ut.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:It,ssr:b}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...i){var x;(x=e.value)===null||x===void 0||x.scrollTo(...i)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}}),Kt={tabFontSizeSmall:"14px",tabFontSizeMedium:"14px",tabFontSizeLarge:"16px",tabGapSmallLine:"36px",tabGapMediumLine:"36px",tabGapLargeLine:"36px",tabGapSmallLineVertical:"8px",tabGapMediumLineVertical:"8px",tabGapLargeLineVertical:"8px",tabPaddingSmallLine:"6px 0",tabPaddingMediumLine:"10px 0",tabPaddingLargeLine:"14px 0",tabPaddingVerticalSmallLine:"6px 12px",tabPaddingVerticalMediumLine:"8px 16px",tabPaddingVerticalLargeLine:"10px 20px",tabGapSmallBar:"36px",tabGapMediumBar:"36px",tabGapLargeBar:"36px",tabGapSmallBarVertical:"8px",tabGapMediumBarVertical:"8px",tabGapLargeBarVertical:"8px",tabPaddingSmallBar:"4px 0",tabPaddingMediumBar:"6px 0",tabPaddingLargeBar:"10px 0",tabPaddingVerticalSmallBar:"6px 12px",tabPaddingVerticalMediumBar:"8px 16px",tabPaddingVerticalLargeBar:"10px 20px",tabGapSmallCard:"4px",tabGapMediumCard:"4px",tabGapLargeCard:"4px",tabGapSmallCardVertical:"4px",tabGapMediumCardVertical:"4px",tabGapLargeCardVertical:"4px",tabPaddingSmallCard:"8px 16px",tabPaddingMediumCard:"10px 20px",tabPaddingLargeCard:"12px 24px",tabPaddingSmallSegment:"4px 0",tabPaddingMediumSegment:"6px 0",tabPaddingLargeSegment:"8px 0",tabPaddingVerticalLargeSegment:"0 8px",tabPaddingVerticalSmallCard:"8px 12px",tabPaddingVerticalMediumCard:"10px 16px",tabPaddingVerticalLargeCard:"12px 20px",tabPaddingVerticalSmallSegment:"0 4px",tabPaddingVerticalMediumSegment:"0 6px",tabGapSmallSegment:"0",tabGapMediumSegment:"0",tabGapLargeSegment:"0",tabGapSmallSegmentVertical:"0",tabGapMediumSegmentVertical:"0",tabGapLargeSegmentVertical:"0",panePaddingSmall:"8px 0 0 0",panePaddingMedium:"12px 0 0 0",panePaddingLarge:"16px 0 0 0",closeSize:"18px",closeIconSize:"14px"};function Yt(e){const{textColor2:n,primaryColor:b,textColorDisabled:c,closeIconColor:i,closeIconColorHover:x,closeIconColorPressed:v,closeColorHover:y,closeColorPressed:C,tabColor:p,baseColor:g,dividerColor:A,fontWeight:L,textColor1:u,borderRadius:w,fontSize:S,fontWeightStrong:R}=e;return Object.assign(Object.assign({},Kt),{colorSegment:p,tabFontSizeCard:S,tabTextColorLine:u,tabTextColorActiveLine:b,tabTextColorHoverLine:b,tabTextColorDisabledLine:c,tabTextColorSegment:u,tabTextColorActiveSegment:n,tabTextColorHoverSegment:n,tabTextColorDisabledSegment:c,tabTextColorBar:u,tabTextColorActiveBar:b,tabTextColorHoverBar:b,tabTextColorDisabledBar:c,tabTextColorCard:u,tabTextColorHoverCard:u,tabTextColorActiveCard:b,tabTextColorDisabledCard:c,barColor:b,closeIconColor:i,closeIconColorHover:x,closeIconColorPressed:v,closeColorHover:y,closeColorPressed:C,closeBorderRadius:w,tabColor:p,tabColorSegment:g,tabBorderColor:A,tabFontWeightActive:L,tabFontWeight:L,tabBorderRadius:w,paneTextColor:n,fontWeightStrong:R})}const qt={common:ht,self:Yt},Be=mt("n-tabs"),Jt={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Qt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Pt(Jt,["displayDirective"])),te=pe({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Qt,setup(e){const{mergedClsPrefixRef:n,valueRef:b,typeRef:c,closableRef:i,tabStyleRef:x,addTabStyleRef:v,tabClassRef:y,addTabClassRef:C,tabChangeIdRef:p,onBeforeLeaveRef:g,triggerRef:A,handleAdd:L,activateTab:u,handleClose:w}=zt(Be);return{trigger:A,mergedClosable:ee(()=>{if(e.internalAddable)return!1;const{closable:S}=e;return S===void 0?i.value:S}),style:x,addStyle:v,tabClass:y,addTabClass:C,clsPrefix:n,value:b,type:c,handleClose(S){S.stopPropagation(),!e.disabled&&w(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){L();return}const{name:S}=e,R=++p.id;if(S!==b.value){const{value:k}=g;k?Promise.resolve(k(e.name,b.value)).then(_=>{_&&p.id===R&&u(S)}):u(S)}}}},render(){const{internalAddable:e,clsPrefix:n,name:b,disabled:c,label:i,tab:x,value:v,mergedClosable:y,trigger:C,$slots:{default:p}}=this,g=i??x;return d("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${n}-tabs-tab-pad`}):null,d("div",Object.assign({key:b,"data-name":b,"data-disabled":c?!0:void 0},yt({class:[`${n}-tabs-tab`,v===b&&`${n}-tabs-tab--active`,c&&`${n}-tabs-tab--disabled`,y&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:C==="click"?this.activateTab:void 0,onMouseenter:C==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${n}-tabs-tab__label`},e?d(Le,null,d("div",{class:`${n}-tabs-tab__height-placeholder`}," "),d(Ct,{clsPrefix:n},{default:()=>d(Ft,null)})):p?p():typeof g=="object"?g:St(g??b)),y&&this.type==="card"?d(wt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:c}):null))}}),Zt=r("tabs",`
...
`,[l("segment-type",[r("tabs-rail",[m("&.transition-disabled",[r("tabs-capsule",`
 ...
 display: flex;
 align-items: center;
 `),z("prefix","padding-right: 16px;"),z("suffix","padding-left: 16px;")]),l("top, bottom",[r("tabs-nav-scroll-wrapper",[m("&::before",`
 top: 0;
 bottom: 0;
 left: 0;
 width: 20px;
 ...
 `),l("disabled",{color:"var(--n-tab-text-color-disabled)"})])]),r("tabs-nav",[l("line-type",[l("top",[z("prefix, suffix",`
 ...
 width: 100%;
 `)])]),l("top",[l("card-type",[r("tabs-scroll-padding","border-bottom: 1px solid var(--n-tab-border-color);"),z("prefix, suffix",`
 border-bottom: 1px solid var(--n-tab-border-color);
 `),r("tabs-tab",`
 ...
 `),r("tabs-pad",`
 border-bottom: 1px solid var(--n-tab-border-color);
 `)])]),l("left",[l("card-type",[r("tabs-scroll-padding","border-right: 1px solid var(--n-tab-border-color);"),z("prefix, suffix",`
 border-right: 1px solid var(--n-tab-border-color);
 `),r("tabs-tab",`
 border-top-left-radius: var(--n-tab-border-radius);
 ...
 `),r("tabs-pad",`
 border-right: 1px solid var(--n-tab-border-color);
 `)])]),l("right",[l("card-type",[r("tabs-scroll-padding","border-left: 1px solid var(--n-tab-border-color);"),z("prefix, suffix",`
 border-left: 1px solid var(--n-tab-border-color);
 `),r("tabs-tab",`
 border-top-right-radius: var(--n-tab-border-radius);
 ...
 `),r("tabs-pad",`
 border-left: 1px solid var(--n-tab-border-color);
 `)])]),l("bottom",[l("card-type",[r("tabs-scroll-padding","border-top: 1px solid var(--n-tab-border-color);"),z("prefix, suffix",`
 border-top: 1px solid var(--n-tab-border-color);
 `),r("tabs-tab",`
 border-bottom-left-radius: var(--n-tab-border-radius);
 border-bottom-right-radius: var(--n-tab-border-radius);
